...
Inside the block for `create_table`, on the first line is a call to `t.timestamps`. 
...
Two columns are defined: `title` and `body`.  These were added 
by the generator because we included them in our
